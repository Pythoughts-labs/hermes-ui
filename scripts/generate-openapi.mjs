...
const openapi = {
  ...
  info: {
    title: 'Hermes UI API',
    description: 'Hermes UI API — chat sessions, scheduled jobs, platform channels, model management, skills, memory, logs, file browser, group chat, and terminal.',
...
const tagMappings = {
  ...
  'routes/hermes/runtime-versions.ts': { name: 'Runtime Versions', description: 'Runtime and UI version management' },
...
openapi.paths['/api/chat-run/runs'] = {
  post: {
    ...
    description: 'Starts a Hermes UI chat run through the chat-run transport and waits for a terminal result. Use this from HTTP/MCP callers that cannot consume Socket.IO streams.',
        ...
        'application/json': {
          schema: {
            ...
            properties: {
              ...
              profile: {
                type: 'string',
                description: 'Hermes UI profile name. Defaults to the authenticated request profile or default.',
              },
              provider: {
                type: 'string',
