...
const chartSrc = computed(() => {
  return 'https://api.star-history.com/svg?repos=Pythoughts-labs%2Fhermes-ui&type=Date'
})

onMounted(async () => {
  try {
    const res = await fetch('https://api.github.com/repos/Pythoughts-labs/hermes-ui')
...
<template>
  <div class="star-panel">
    ...
    <div class="star-badges reveal reveal-delay-1">
      <a
        class="star-btn"
        href="https://github.com/Pythoughts-labs/hermes-ui"
        target="_blank"
        rel="noopener"
      >
    ...
    <div class="star-chart reveal reveal-delay-2">
      <a
        href="https://www.star-history.com/?type=date&repos=Pythoughts-labs%2Fhermes-ui"
        target="_blank"
