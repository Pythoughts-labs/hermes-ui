...
const GEMINI_CALLBACK_BIND_HOST = process.env.HERMES_UI_GEMINI_CALLBACK_BIND_HOST?.trim() || GEMINI_REDIRECT_HOST
    ...
    const server = createServer((req, res) => {
      void (async () => {
        ...
        try {
          ...
          closeServer(session)
          const body = html('success', 'You can close this tab and return to Hermes UI.')
