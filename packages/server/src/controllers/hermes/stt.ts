...
const MISSING_STT_PROMPT_TEXT = 'Speech-to-text is not configured for the current profile. Configure it in Settings before using voice input.'
const MISSING_STT_PROMPT_PCM_URL =
  '/audio/current-profile-stt-not-configured.s16le.pcm'
const STT_TRANSCRIBE_FAILED_PROMPT_TEXT = 'Speech-to-text transcription failed. Configure a speech-to-text provider in Settings before retrying.'
const STT_TRANSCRIBE_FAILED_PROMPT_PCM_URL =
  '/audio/stt-transcribe-failed.s16le.pcm'
