...
const OPENROUTER_UI_ATTRIBUTION_ENV = {
  HERMES_OPENROUTER_APP_REFERER: 'https://github.com/Pythoughts-labs/hermes-ui',
  HERMES_OPENROUTER_APP_TITLE: 'Hermes UI',
...
export function buildAgentBridgeProcessEnv(endpoint: string, hermesHome: string | undefined, agentRoot: string | undefined): NodeJS.ProcessEnv {
  const env: NodeJS.ProcessEnv = {
    ...
    HERMES_OPENROUTER_APP_REFERER: process.env.HERMES_OPENROUTER_APP_REFERER || OPENROUTER_UI_ATTRIBUTION_ENV.HERMES_OPENROUTER_APP_REFERER,
    HERMES_OPENROUTER_APP_TITLE: process.env.HERMES_OPENROUTER_APP_TITLE || OPENROUTER_UI_ATTRIBUTION_ENV.HERMES_OPENROUTER_APP_TITLE,
    HERMES_OPENROUTER_APP_CATEGORIES: process.env.HERMES_OPENROUTER_APP_CATEGORIES || OPENROUTER_UI_ATTRIBUTION_ENV.HERMES_OPENROUTER_APP_CATEGORIES,
...
export class AgentBridgeManager {
  ...
  private async prepareEndpoint(): Promise<void> {
    ...
    // Preserve surviving bridge processes by default so UI restarts do not
