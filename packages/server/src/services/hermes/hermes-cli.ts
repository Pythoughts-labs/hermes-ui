 ...
 * Prefer the HERMES_BIN environment variable; otherwise fall back to the
  ...
  try {
    ...
    for (const line of lines) {
      ...
      if (match) {
        ...
        // Support a wider set of log types: agent, errors, gateway, and any
        // other log file the Hermes runtime happens to emit
