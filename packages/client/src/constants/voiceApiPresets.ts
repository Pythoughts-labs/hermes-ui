...
export const VOICE_API_PRESETS: VoiceApiPreset[] = [
  // TTS Presets
  {
    ...
    provider: 'local',
    label: 'Local TTS',
    labelKey: 'settings.voice.presetLocalTtsLabel',
    description: 'On-device speech synthesis powered by Kokoro-82M. No network, no API key.',
    descriptionKey: 'settings.voice.presetLocalTtsDescription',
    isBuiltin: true,
    isLocal: true,
