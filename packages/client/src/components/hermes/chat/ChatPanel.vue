...
import BrightnessToggle from "@/components/layout/BrightnessToggle.vue";
import SidebarBrand from "@/components/layout/SidebarBrand.vue";
// SettingsCircuitBadge removed: was a decoration-only link to ESP32 docs.
  ...
  <div class="chat-panel">
    ...
    >
      <div v-if="showSessions" class="page-sidebar-top">
        <SidebarBrand class="page-sidebar-brand" />
        <PageSidebarNav
      ...
      <div v-if="showSessions" class="page-sidebar-bottom">
        ...
        <BrightnessToggle class="page-sidebar-theme-btn" />
      </div>
    </aside>
