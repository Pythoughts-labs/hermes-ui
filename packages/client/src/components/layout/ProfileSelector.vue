...
import { fetchAvatarPresets, urlToDataUrl } from '@/api/auth'
  ...
  <div class="profile-selector">
    ...
    >
      <div v-if="editingProfile" class="avatar-editor">
        ...
        <div v-if="presetAvatars.length > 0" class="avatar-editor-presets">
          <div class="avatar-editor-hint">{{ t('profiles.avatar.presetsHint') }}</div>
