...
function handleCustomSubmit() {
  ...
  // Block disabled models so the custom input cannot bypass the greyed-out
...
async function handleRefresh() {
  ...
  try {
    ...
    // Ensure the rotation animation completes at least one full cycle so the icon
// does not just flash when the request is too fast
