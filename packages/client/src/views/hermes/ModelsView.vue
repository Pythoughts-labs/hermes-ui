...
async function loadProvidersForProfile() {
  ...
  // First invalidate the backend Copilot cache (so the next list reflects gh logout / VS Code
  // exit immediately), then fetch providers and the appStore model display-name config.
  // check-token failures must not block.
