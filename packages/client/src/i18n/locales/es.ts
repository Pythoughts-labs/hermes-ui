export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Nombre de usuario predeterminado: admin. Contrasena predeterminada: admin.',
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Ejecuta "hermes-ui update" en la terminal para actualizar',
  ...
  runtimeVersions: {
    ...
    deleteUiConfirm: '¿Eliminar UI {version}?',
    deleteRuntimeSuccess: 'Runtime eliminado',
    deleteUiSuccess: 'UI eliminado',
    refresh: 'Actualizar',
    ...
    activateSuccess: 'Selección de versión guardada. Reinicia Hermes UI para usarla.',
    jobStatus: {
      queued: 'En cola',
    ...
    jobStage: {
      ...
      resolveUi: 'Resolviendo paquete UI',
      verifyUi: 'Verificando archivo UI',
      extractUi: 'Extrayendo archivo UI',
      installUi: 'Instalando UI',
      completed: 'Completada',
      failed: 'Fallida',
    },
  },
  ...
  chat: {
    ...
    sessionScopeHint: 'Chat solo muestra sesiones de UI/API Server. Las sesiones de CLI, Telegram, Discord, Cron y otros canales son de solo lectura en Historial.',
    ...
    importToUi: 'Importar a UI',
    importSessionSuccess: 'Sesion importada a UI',
    importSessionAlreadyExists: 'La sesion ya existe en UI',
    ...
    searchScope: 'Alcance de búsqueda: solo base de datos local de sesiones de UI; no incluye sesiones históricas Hermes de solo lectura.',
...
jobTriggered: 'Job ejecutado',
  ...
  models: {
    ...
    visibilityHint: 'Solo afecta al selector de modelos y a la página de modelos de UI. No modifica la configuración provider/model de Hermes CLI; las llamadas siguen usando el ID original del modelo.',
    ...
    aliasHint: 'Solo cambia el nombre visible en UI. Hermes sigue recibiendo el ID original del modelo.',
    aliasEdit: 'Renombrar',
  ...
  profiles: {
    ...
    avatar: {
      ...
      presetsHint: 'Elige un avatar predefinido de la galería',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla qué gateways de perfiles Hermes locales inicia la UI al arrancar. Se guarda en la configuración de la UI, no en el config.yaml del perfil.',
      ...
      managementHint: 'Requiere Hermes Agent 0.17.0 o posterior. Al activarlo, UI escribe multiplex_profiles para que el gateway default sirva todos los perfiles; otros perfiles no pueden configurar entradas de mensajeria separadas como Feishu, Weixin o QQBot. Al desactivarlo elimina esa configuración.',
    ...
    voice: {
      ...
      testAction: 'Probar',
      connect: 'Conectar',
      presetLocalTtsLabel: 'Edge TTS',
      presetLocalTtsDescription: 'Voces en la nube gratuitas de alta calidad de Microsoft Edge.',
      ...
      sttFailureHintNetworkCustom: 'El servidor no pudo alcanzar el endpoint STT personalizado. Comprueba que {endpoint} sea accesible desde el servidor UI y compatible con OpenAI.',

      sttFailureHintNetwork: 'El servidor UI no pudo alcanzar el proveedor STT. Revisa red/proxy/firewall y reintenta.',
  ...
  githubPreview: {
    ...
    description: "Clona el tag de GitHub seleccionado en el espacio de vista previa de UI, instala dependencias y lo ejecuta con los puertos de desarrollo.",
    refresh: "Actualizar",
    ...
    stop: "Detener",
    note: "El código de vista previa se guarda bajo el directorio de datos de UI. Producción sigue en el puerto 8648; la vista previa usa frontend 8651 y backend 8650.",
    path: "Ruta de vista previa",
    uiHome: "Datos de vista previa",
  ...
  changelog: {
    ...
    new_0_6_21_6: 'UI restart, update y upgrade dentro de la app ahora detienen Agent Bridge broker por defecto para no reutilizar procesos Python bridge antiguos',
    ...
    new_0_6_18_2: 'Hermes UI MCP se divide en toolsets api, devices y use, con nuevas acciones de sesion, modelos, chat-run y ops',
    ...
    new_0_6_16_7: 'Los assets estaticos grandes evitan Brotli dinamico, mejorando la entrega del UI empaquetado bajo carga',
    new_0_6_16_8: 'Los flujos de outbound relay y login MCU estan disponibles para integraciones tipo connector',
    new_0_6_16_9: 'La CLI de UI anade --no-open para scripts y lanzamientos headless',
    ...
    new_0_6_13_5: 'Las actualizaciones de escritorio son mas fiables: las actualizaciones de Windows cierran procesos Hermes UI residuales, revisan Cloudflare primero y mantienen GitHub como feed de respaldo',
    new_0_6_13_6: 'La automatizacion de releases mantiene UI y Docker fuera de GitHub Latest, mientras que las releases completas de escritorio se promocionan manualmente a Latest tras una compilacion correcta',
  },
