export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Nome de usuario padrao: admin. Senha padrao: admin.',
  ...
  sidebar: {
    ...
    connected: 'Conectado',
    disconnected: 'Desconectado',
    updateTip: 'Execute "hermes-ui update" no terminal para atualizar',
  ...
  runtimeVersions: {
    ...
    deleteUiConfirm: 'Excluir UI {version}?',
    deleteRuntimeSuccess: 'Runtime excluído',
    deleteUiSuccess: 'UI excluído',
    refresh: 'Atualizar',
    ...
    activateSuccess: 'Seleção de versão salva. Reinicie o Hermes UI para usá-la.',
    jobStatus: {
      queued: 'Na fila',
      running: 'Em execução',
      completed: 'Concluída',
    ...
    jobStage: {
      ...
      resolveUi: 'Resolvendo pacote UI',
      verifyUi: 'Verificando arquivo UI',
      extractUi: 'Extraindo arquivo UI',
  ...
  chat: {
    ...
    sessionScopeHint: 'O chat mostra apenas sessões da UI/API Server. Sessões de CLI, Telegram, Discord, Cron e outros canais são somente leitura no Histórico.',
    ...
    importToUi: 'Importar para UI',
    importSessionSuccess: 'Sessão importada para UI',
    importSessionAlreadyExists: 'A sessão já existe no UI',
    ...
    searchScope: 'Escopo da busca: apenas banco local de sessões da UI; sessões históricas Hermes somente leitura não são incluídas.',
...
jobTriggered: 'Job acionado',
  ...
  models: {
    ...
    visibilityHint: 'Afeta apenas o seletor de modelos e a página de modelos da UI. A configuração provider/model da Hermes CLI não é alterada; as chamadas ainda usam o ID original do modelo.',
    ...
    aliasHint: 'Altera apenas o nome exibido na UI. O Hermes ainda recebe o ID original do modelo.',
    aliasEdit: 'Renomear',
  ...
  profiles: {
    ...
    avatar: {
      ...
      presetsHint: "Escolha um avatar predefinido na galeria",
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Controla quais gateways de perfis Hermes locais a UI inicia durante a inicialização. Isto é salvo na configuração da UI, não no config.yaml do perfil.',
      ...
      managementHint: 'Requer Hermes Agent 0.17.0 ou superior. Quando ativado, a UI grava multiplex_profiles para o gateway default servir todos os perfis; outros perfis nao podem configurar entradas de mensagens separadas como Feishu, Weixin ou QQBot. Ao desativar, remove essa configuração.',
    ...
    voice: {
      ...
      presetLocalTtsDescription: 'Vozes em nuvem gratuitas e de alta qualidade do Microsoft Edge.',
      ...
      sttFailureHintNetworkCustom: 'O servidor nao conseguiu acessar o endpoint STT personalizado. Verifique se {endpoint} e acessivel pelo servidor UI e compativel com OpenAI.',

      sttFailureHintNetwork: 'O servidor UI nao conseguiu acessar o provedor STT. Verifique rede/proxy/firewall e tente novamente.',
  ...
  githubPreview: {
    ...
    description: "Clona a tag do GitHub selecionada para o workspace de prévia do UI, instala dependências e executa com as portas de desenvolvimento.",
    refresh: "Atualizar",
    ...
    stop: "Parar",
    note: "O código de prévia é armazenado no diretório de dados do UI. Produção permanece na porta 8648; a prévia usa frontend 8651 e backend 8650.",
    path: "Caminho da prévia",
    uiHome: "Dados da prévia",
  ...
  changelog: {
    ...
    new_0_6_21_6: 'UI restart, update e upgrade dentro do app agora param o Agent Bridge broker por padrao para evitar reutilizar processos Python bridge antigos',
    ...
    new_0_6_18_2: 'Hermes UI MCP foi dividido em toolsets api, devices e use, com novas acoes de session, model, chat-run e ops',
    ...
    new_0_6_16_7: 'Assets estaticos grandes evitam Brotli dinamico, melhorando a entrega do UI empacotado sob carga',
    new_0_6_16_8: 'Fluxos de outbound relay e login MCU estao disponiveis para integracoes do tipo connector',
    new_0_6_16_9: 'A CLI do UI adiciona --no-open para scripts e execucoes headless',
    ...
    new_0_6_13_5: 'As atualizacoes desktop estao mais confiaveis: upgrades no Windows fecham processos Hermes UI residuais, verificam Cloudflare primeiro e mantem GitHub como feed de fallback',
    new_0_6_13_6: 'A automacao de releases mantem UI e Docker fora do GitHub Latest, enquanto releases desktop completas sao promovidas manualmente para Latest apos build bem-sucedido',
  },
