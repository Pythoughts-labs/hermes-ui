export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Default username: admin. Default password: admin.',
  ...
  sidebar: {
    ...
    expand: 'Expand menu',
    updateTip: 'Run "hermes-ui update" in terminal to update',
  ...
  runtimeVersions: {
    ...
    jobStage: {
      ...
      resolveUi: 'Resolving UI package',
      verifyUi: 'Verifying UI archive',
      extractUi: 'Extracting UI archive',
      installUi: 'Installing UI',
      completed: 'Completed',
      failed: 'Failed',
    },
  },
  ...
  chat: {
    ...
    sessionScopeHint: 'Chat shows UI/API Server sessions only. CLI, Telegram, Discord, Cron, and other channel sessions are read-only in History.',
    ...
    searchScope: 'Search scope: UI local session database only. Read-only Hermes history sessions are not included.',
    ...
    importToUi: 'Import to UI',
    importSessionSuccess: 'Session imported to UI',
    importSessionAlreadyExists: 'Session already exists in UI',
  ...
  models: {
    ...
    visibilityHint: 'Only affects the UI model picker and Models page. Hermes CLI provider/model config is not rewritten; calls still use canonical model IDs.',
  ...
  profiles: {
    ...
    avatar: {
      ...
      presetsHint: 'Choose a preset avatar from the gallery',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Control which local Hermes profile gateways the UI starts during startup. This is stored in the UI config, not a profile config.yaml.',
      ...
      managementHint: 'Requires Hermes Agent 0.17.0 or later. When enabled, UI writes multiplex_profiles so the default gateway serves every profile; other profiles cannot configure separate Feishu, Weixin, QQBot, or similar messaging entrypoints. Turning it off removes that config.',
      managementAuto: 'Auto',
    ...
    voice: {
      ...
      ttsSectionLabel: 'Text-to-speech',
      sttSectionLabel: 'Speech-to-text',
      ...
      testAction: 'Test',
      connect: 'Connect',
      presetLocalTtsLabel: 'Local TTS',
      presetLocalTtsDescription: 'On-device speech synthesis powered by Kokoro-82M. No network, no API key.',
      localModel: 'Model',
      localModelLabel: 'Model',
      localModelDefault: 'Default (Kokoro-82M)',
      localFetchModels: 'Fetch from GitHub',
      localModelReady: 'Ready',
      localModelDownloading: 'Downloading',
      localModelInstalling: 'Installing dependencies…',
      localModelMissing: 'Not downloaded',
      localModelError: 'Download failed',
      localModelNotReady: 'Download the local model before testing.',
      localDownload: 'Download model',
      localRemove: 'Remove model',
      localSpeed: 'Speech speed',
      localDownloadStarting: 'Starting download…',
      localDownloadComplete: 'Model ready',
      localDownloadFailed: 'Download failed',
      localRemoveComplete: 'Model removed',
      ...
      sttFailureHintNetworkCustom: 'The server could not reach the custom STT endpoint. Check that {endpoint} is reachable from the UI server and is OpenAI-compatible.',

      sttFailureHintNetwork: 'The UI server could not reach the STT provider. Check network/proxy/firewall and retry.',
  ...
  githubPreview: {
    ...
    description: "Clone a selected GitHub tag into the UI preview workspace, install dependencies, and run it with the development ports.",
    refresh: "Refresh",
    ...
    start: "Start Preview",
    stop: "Stop",
    note: "Preview code is stored under the UI data home. Production remains on port 8648; preview development runs on frontend 8651 and backend 8650.",
    path: "Preview Path",
    uiHome: "Preview Data Home",
  ...
  // Changelog
  changelog: {
    new_0_1_0_1: 'Initial public release of Hermes UI: a self-hosted Hermes Agent dashboard distributed as a desktop app, an npm package, and a Docker image',
    ...
    new_0_6_21_3: 'The Hermes UI MCP use toolset can now list, create, update, delete, run, stop, delete runs, and rerun workflows from a selected node',
    ...
    new_0_6_21_6: 'UI restart, update, and in-app upgrade now stop the Agent Bridge broker by default so new builds do not attach to stale Python bridge processes',
    ...
    new_0_6_18_2: 'Hermes UI MCP is split into focused api, devices, and use toolsets with new session, model, chat-run, and ops actions',
    ...
    new_0_6_16_7: 'Large static assets avoid dynamic Brotli compression, improving packaged UI delivery under load',
    new_0_6_16_8: 'Outbound relay and MCU login flows are available for connector-style integrations',
    new_0_6_16_9: 'The UI CLI adds a --no-open flag for scripts and headless launches',
    ...
    new_0_6_13_5: 'Desktop updates are more reliable: Windows upgrades close stale Hermes UI processes, Cloudflare is checked first, and GitHub remains the fallback feed',
    new_0_6_13_6: 'Release automation now keeps UI and Docker releases out of GitHub Latest while full desktop releases are manually promoted to Latest',
  },
}
