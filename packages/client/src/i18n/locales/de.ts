export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Standard-Benutzername: admin. Standard-Passwort: admin.',
  ...
  sidebar: {
    ...
    connected: 'Verbunden',
    disconnected: 'Getrennt',
    updateTip: 'Fuhren Sie "hermes-ui update" im Terminal aus, um zu aktualisieren',
  ...
  runtimeVersions: {
    ...
    deleteUiConfirm: 'UI {version} löschen?',
    deleteRuntimeSuccess: 'Runtime gelöscht',
    deleteUiSuccess: 'UI gelöscht',
    refresh: 'Aktualisieren',
    ...
    activateSuccess: 'Versionsauswahl gespeichert. Starten Sie Hermes UI neu, um sie zu verwenden.',
    jobStatus: {
    ...
    jobStage: {
      ...
      resolveUi: 'UI-Paket wird aufgelöst',
      verifyUi: 'UI-Archiv wird geprüft',
      extractUi: 'UI-Archiv wird entpackt',
      installUi: 'UI wird installiert',
      completed: 'Abgeschlossen',
      failed: 'Fehlgeschlagen',
    },
  },
  ...
  chat: {
    ...
    sessions: 'Sitzungen',
    uiSessions: 'Sitzungen',
    allProfiles: 'Alle Profile',
    profileMissingModelsTip: 'Profil "{profile}" hat keinen verfuegbaren Provider oder kein Modell fuer diese Sitzung',
    sessionScopeHint: 'Chat zeigt nur UI/API-Server-Sitzungen. CLI-, Telegram-, Discord-, Cron- und andere Kanal-Sitzungen sind schreibgeschützt im Verlauf.',
    ...
    importToUi: 'In UI importieren',
    importSessionSuccess: 'Sitzung in UI importiert',
    importSessionAlreadyExists: 'Sitzung existiert bereits in UI',
    ...
    searchScope: 'Suchbereich: nur lokale UI-Sitzungsdatenbank; schreibgeschützte Hermes-Verlaufssitzungen sind nicht enthalten.',
...
jobTriggered: 'Job ausgelost',
  ...
  models: {
    ...
    visibilityHint: 'Wirkt sich nur auf Modellauswahl und Modellseite der UI aus. Die provider/model-Konfiguration der Hermes CLI wird nicht geändert; Aufrufe verwenden weiterhin die ursprüngliche Modell-ID.',
    ...
    aliasHint: 'Ändert nur den Anzeigenamen in der UI. Hermes erhält weiterhin die ursprüngliche Modell-ID.',
  ...
  profiles: {
    ...
    avatar: {
      ...
      presetsHint: "Wähle einen vorgefertigten Avatar aus der Galerie aus",
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Legt fest, welche lokalen Hermes-Profile-Gateways die UI beim Start startet. Diese Einstellung wird in der UI-Konfiguration gespeichert, nicht in der profile config.yaml.',
      enabled: 'Gateways automatisch starten',
      enabledHint: 'Wenn deaktiviert, startet die UI beim Start kein Profile-Gateway automatisch.',
      management: 'Vereinheitlichtes Gateway',
      managementHint: 'Erfordert Hermes Agent 0.17.0 oder neuer. Wenn aktiviert, schreibt die UI multiplex_profiles, damit das default gateway alle Profile bedient; andere Profile konnen keine separaten Feishu-, Weixin-, QQBot- oder ahnlichen Messaging-Einstiegspunkte konfigurieren. Beim Deaktivieren wird diese Einstellung entfernt.',
    ...
    voice: {
      ...
      presetLocalTtsDescription: 'Kostenlose hochwertige Cloud-Stimmen von Microsoft Edge.',
      ...
      sttFailureHintNetworkCustom: 'Der Server konnte den benutzerdefinierten STT-Endpunkt nicht erreichen. Pruefe, ob {endpoint} vom UI-Server aus erreichbar und OpenAI-kompatibel ist.',

      sttFailureHintNetwork: 'Der UI-Server konnte den STT-Anbieter nicht erreichen. Pruefe Netzwerk/Proxy/Firewall und versuche es erneut.',
  ...
  githubPreview: {
    ...
    description: "Klont den ausgewählten GitHub-Tag in den UI-Vorschaubereich, installiert Abhängigkeiten und startet ihn mit den Entwicklungsports.",
    refresh: "Aktualisieren",
    ...
    stop: "Stoppen",
    note: "Der Vorschaucode wird im UI-Datenverzeichnis gespeichert. Produktion bleibt auf Port 8648; die Vorschau nutzt Frontend 8651 und Backend 8650.",
    path: "Vorschaupfad",
    uiHome: "Vorschau-Datenverzeichnis",
  ...
  changelog: {
    ...
    new_0_6_21_6: 'UI restart, update und In-App-Upgrade stoppen den Agent Bridge Broker jetzt standardmaessig, damit neue Builds keine alten Python-Bridge-Prozesse wiederverwenden',
    ...
    new_0_6_18_2: 'Hermes UI MCP ist in fokussierte api-, devices- und use-Toolsets aufgeteilt, mit neuen Session-, Modell-, Chat-Run- und Ops-Aktionen',
    ...
    new_0_6_16_7: 'Grosse statische Assets umgehen dynamische Brotli-Kompression und verbessern die Auslieferung der paketierten UI unter Last',
    new_0_6_16_8: 'Outbound Relay und MCU-Login-Flows sind fuer Connector-Integrationen verfuegbar',
    new_0_6_16_9: 'Die UI CLI erhaelt ein --no-open Flag fuer Skripte und Headless-Starts',
    ...
    new_0_6_13_6: 'Die Release-Automatisierung markiert UI- und Docker-Releases nicht mehr als GitHub Latest; vollstaendige Desktop-Releases werden nach erfolgreichem manuellem Build zu Latest gemacht',
  },
