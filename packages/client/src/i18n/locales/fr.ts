export default {
  ...
  login: {
    ...
    defaultCredentialsHint: 'Nom d utilisateur par defaut : admin. Mot de passe par defaut : admin.',
  ...
  sidebar: {
    ...
    connected: 'Connecte',
    disconnected: 'Deconnecte',
    updateTip: 'Executez "hermes-ui update" dans le terminal pour mettre a jour',
  ...
  runtimeVersions: {
    ...
    deleteUiConfirm: 'Supprimer UI {version} ?',
    deleteRuntimeSuccess: 'Runtime supprimé',
    deleteUiSuccess: 'UI supprimé',
    refresh: 'Actualiser',
    ...
    activateSuccess: 'Sélection de version enregistrée. Redémarrez Hermes UI pour l’utiliser.',
    jobStatus: {
      queued: 'En attente',
      running: 'En cours',
      completed: 'Terminé',
    ...
    jobStage: {
      ...
      resolveUi: 'Résolution du package UI',
      verifyUi: 'Vérification de l’archive UI',
      extractUi: 'Extraction de l’archive UI',
      installUi: 'Installation de UI',
      completed: 'Terminé',
      failed: 'Échec',
    },
  },
  ...
  chat: {
    ...
    sessionScopeHint: 'Le chat affiche uniquement les sessions UI/API Server. Les sessions CLI, Telegram, Discord, Cron et autres canaux sont en lecture seule dans Historique.',
    ...
    importToUi: 'Importer dans UI',
    importSessionSuccess: 'Session importée dans UI',
    importSessionAlreadyExists: 'La session existe déjà dans UI',
    ...
    searchScope: 'Portée de recherche : base locale des sessions UI uniquement ; les sessions d’historique Hermes en lecture seule ne sont pas incluses.',
...
jobTriggered: 'Job declenche',
  ...
  models: {
    ...
    visibilityHint: 'Affecte uniquement le sélecteur de modèles et la page Modèles de la UI. La configuration provider/model de Hermes CLI n’est pas modifiée ; les appels utilisent toujours l’ID de modèle d’origine.',
    ...
    aliasHint: 'Modifie uniquement le nom affiché dans la UI. Hermes reçoit toujours l’ID de modèle d’origine.',
    aliasEdit: 'Renommer',
  ...
  profiles: {
    ...
    avatar: {
      ...
      presetsHint: 'Choisissez un avatar prédéfini dans la galerie',
  ...
  settings: {
    ...
    gatewayAutoStart: {
      ...
      description: 'Contrôle les gateways de profils Hermes locaux que la UI démarre au lancement. Cette option est stockée dans la configuration UI, pas dans le config.yaml du profil.',
    ...
    voice: {
      ...
      presetLocalTtsDescription: 'Voix cloud gratuites de haute qualite de Microsoft Edge.',
      ...
      sttFailureHintNetworkCustom: 'Le serveur n’a pas pu joindre l’endpoint STT personnalise. Verifiez que {endpoint} est joignable depuis le serveur UI et compatible OpenAI.',

      sttFailureHintNetwork: 'Le serveur UI n’a pas pu joindre le fournisseur STT. Verifiez reseau/proxy/pare-feu et reessayez.',
  ...
  githubPreview: {
    ...
    description: "Clone le tag GitHub sélectionné dans l’espace de prévisualisation UI, installe les dépendances, puis lance l’application sur les ports de développement.",
    refresh: "Actualiser",
    ...
    stop: "Arrêter",
    note: "Le code de prévisualisation est stocké dans le dossier de données UI. La production reste sur le port 8648 ; la prévisualisation utilise le frontend 8651 et le backend 8650.",
    path: "Chemin de prévisualisation",
    uiHome: "Données de prévisualisation",
  ...
  changelog: {
    ...
    new_0_6_21_6: 'UI restart, update et upgrade in-app arretent maintenant Agent Bridge broker par defaut afin d eviter de reutiliser un vieux process Python bridge',
    ...
    new_0_6_18_2: 'Hermes UI MCP est separe en toolsets api, devices et use, avec de nouvelles actions session, model, chat-run et ops',
    ...
    new_0_6_16_7: 'Les grands assets statiques evitent la compression Brotli dynamique, ameliorant la livraison du UI package sous charge',
    new_0_6_16_8: 'Les flux outbound relay et login MCU sont disponibles pour les integrations de type connector',
    new_0_6_16_9: 'La CLI UI ajoute --no-open pour les scripts et les lancements headless',
    ...
    new_0_6_13_5: 'Les mises a jour desktop sont plus fiables : les mises a niveau Windows ferment les anciens processus Hermes UI, Cloudflare est verifie en premier et GitHub reste le flux de secours',
    new_0_6_13_6: 'L automatisation des releases garde les releases UI et Docker hors de GitHub Latest, tandis que les releases desktop completes sont promues manuellement en Latest apres build reussi',
  },
