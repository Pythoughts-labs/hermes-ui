...
export interface CreateProfileResult {
  success: boolean
  /** Names of exclusive platform credential keys cleared when clone=true */
  strippedCredentials?: string[]
  /** Names of exclusive platforms disabled when clone=true */
  disabledPlatforms?: string[]
  /** Inline credential field paths cleared in config.yaml when clone=true */
