...
describe('agent bridge manager command resolution', () => {
  ...
  it('injects UI OpenRouter attribution into the bridge process env by default', async () => {
    ...
    expect(env.HERMES_OPENROUTER_APP_REFERER).toBe('https://github.com/Pythoughts-labs/hermes-ui')
    expect(env.HERMES_OPENROUTER_APP_TITLE).toBe('Hermes UI')
