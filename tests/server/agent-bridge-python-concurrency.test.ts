...
preview_endpoint = bridge._worker_endpoint("default", "ipc:///tmp/hermes-ui-preview/agent-bridge.sock")
...
preview_broker = bridge.BridgeBroker("ipc:///tmp/hermes-ui-preview/agent-bridge.sock")
