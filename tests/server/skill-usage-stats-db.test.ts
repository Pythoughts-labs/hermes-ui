...
function createUiDb(): DatabaseSync {
...
describe('Hermes skill usage analytics DB aggregation', () => {
  ...
  it('counts completed skill loads and edits from UI sessions inside the requested profile and period', async () => {
